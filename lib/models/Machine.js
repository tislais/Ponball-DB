...
export default class Machine {
  ...
  static async insert({ 
    ...
    const { rows } = await pool.query(
      ...
      RETURNING *`,
      [ipdbId, title, type, manufacturerId, manufactureDate, production, mpuId, specialty, design, art, dotsAnimation, mechanics, sound, software, ruleSheets, roms, docs, theme, features, notes]
    );
